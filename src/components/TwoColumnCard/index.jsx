  ...
  return (
    <motion.div initial="offscreen" whileInView="onscreen" viewport={{ once: true }} className="grid grid-cols-1 gap-10 items-center md:grid-cols-2">
      ...
      >
        ...
        <ul className="text-base text-primary-400 list-inside list-disc dark:text-neutral-200">
          <li>Developed responsive, user-friendly e-commerce websites using modern front-end technologies</li>
          <li>Collaborated with design and backend teams to implement new features and optimize site performance</li>
          <li>Maintained and updated existing e-commerce sites to ensure smooth operation and address any issues</li>
        </ul>
      </motion.div>
    </motion.div>
  );
